...
# It correctly exposes the underlying ASGI app for Vercel.
#
...
# --- Auth Provider ---
# The DeprecationWarning you see for this is OK. It's not an error. You can ignore it.
...
# --- MCP SERVER SETUP ---
# We create the 'mcp' object as intended by the library.
mcp = FastMCP(
...
# --- Tools ---
# We use the standard @mcp.tool decorator.
@mcp.tool
